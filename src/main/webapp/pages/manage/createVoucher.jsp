	...
	<div class="cardmanage">
		...
		<div>
			<div class="left media_preview_area"
				...
				<div class="msg_card">
					<div class="msg_card_inner">
						...
						<div class="js_preview msg_card_section shop disabled" id="img_preview" style="padding: 0px;">
							<div id="imglogo" style="height: 150px; background-color: green;">
								...
								<div class="text-center">
									<span style="font-size: 20px; color: #fff; letter-spacing: 3px;"class="title">卡券标题示例</span>
								</div>
								<div class="clearfix"></div>
								<div class="text-center " style="margin-top: 3px;">
									<span style="font-size: 14px; color: #fff; font-style: italic;" class="subtitle">卡券副标题示例</span>
								</div>
								<div class="clearfix"></div>
								<div class="text-center">
									<span style="font-size: 14px; color: #fff;">有效期：</span>
									<span style="color: #fff;" class="startTime">2015.10.10</span>
									<span style="color: #fff;" class="">-</span>
									<span style="color: #fff;" class="endTime">2015.11.11</span>
								</div>
								<div class="deco"></div>
							</div>
						...
						<div>
							<ul id="myTab" class="nav nav-tabs cardactive">
								...
								<li class="clearfix li"><a href="#see" data-toggle="tab" id="picsee"
									style="width: 320px; text-align: center; color: #000;">卡片预览</a>
								</li>
							</ul>
							<div class="m10 text-center">
								<form
									action="${prourl}/activeVoucher"
									method="post">
			...
			<div class="right setright"
				style="height: 500px; width: 660px; position: relative;">
				<div style="margin: 10px;">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade in active" id="home">
							...
							<input type="hidden" name="token" value="${sessionScope.token}" /> 
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="button" class="left btn btn-default" value="确定" id="findBusinessName"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="pick-a-color form-control" value="green"
											id="inputPassword4" placeholder="颜色示意框" name="background">
									</div>
									<div class="col-sm-3">
										<input type="button" class="left btn btn-default" value="确定" name="choosecolor"/>
									</div>
								</div>
								<div class="clearfix"></div>
								...
								<div class=" text-right" style="margin-top: -32px;">
									<input type="button" id="createvoucher" class="btn btn-default" value="保存"
						...
						<div class="tab-pane fade" id="checkset">
							...
							<form id="checksetform">
								...
								<div class="form-group" style="margin-top: 30px;">
									<div class=" col-sm-10">
										<div class="checkbox">
											<label> <input type="checkbox" checked="checked" name="voucherUseRole" value="1">用户可以分享领券连接
											</label>
										</div>
										<div class="checkbox">
											<label> <input type="checkbox" checked="checked" name="voucherUseRole" value="2">用户领券后可以转赠其他好友
											</label>
										</div>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<form id="adaptform">
									...
									<label class="radio-inline"> <input type="radio"
										name="radioStore" id="inlineRadio3" class="radio_Store" checked="checked">
										指定门店适用 <br/> 
										<span class="frm_tips left">添加指定门店</span> 
										<select name="adaptedStore"  multiple="multiple">
										</select>
									</label> <br/> 
						...
						<div class="tab-pane fade" id="see">
							...
							<div id="imglogosee" style="height: 250px; background-color: green;">
								<div class="m10">
									<img src="${pro}/images/oflogo.png" class="img-logo" alt="" />
								...
								<div class="text-center" style="margin-top: 8px;">
									<span style="font-size: 25px; color: #fff; letter-spacing: 13px;"class="title">卡券标题示例</span>
								</div>
								<div class="clearfix"></div>
								<div class="text-center" style="margin-top: 18px;">
									<span style="font-size: 18px; color: #fff; font-style: italic;letter-spacing: 3px;" class="subtitle">卡券副标题示例</span>
								</div>
								<div class=""></div>
								<div class="text-center" style="margin-top: 10px;">
									<span style="font-size: 16px; color: #fff;letter-spacing: 3px;">有效期：</span>
									<span style="color: #fff; font-size: 16px;" class="startTime">2015.10.10</span>
									<span style="color: #fff; font-size: 16px;" class="">-</span>
									<span style="color: #fff; font-size: 16px;" class="endTime">2015.11.11</span>
								</div>
								<div class="deco"></div>
							</div>
						</div>
