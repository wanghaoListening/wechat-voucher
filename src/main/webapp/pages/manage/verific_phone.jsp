...
<body style="background-color: #f4f5f9;">
    ...
    <div class="Search">
    	<div class="inp">
    		<input style="font-size:18px;color:#000;" class="Search_Inp" type="text" value="" id="searchvalue"/>
		...
		<div class="msg_card_inner">
			...
			<div>
				...
				<div class="list-group ul-li-a" style="border-radius: 0px;">
					<a href="${prourl}/getDiscDetail?voucherId=${voucher.voucherId}" class="list-group-item " 
						style="border-radius: 0px;">查看详情 <span class=" right ul-li"></span>
					</a>
				</div>
			</div>
